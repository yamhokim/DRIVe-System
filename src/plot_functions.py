...
def plot_eye_data(time_data, ear_data, blink_data, file_name, interval_number):
  ...
  # Save the figure
  plt.savefig(f"{file_name}_interval_{interval_number}_eyedata.png", bbox_inches='tight')
  plt.clf()


def plot_mouth_data(time_data, mar_data, yawn_data, file_name, interval_number):
  fig, axes = plt.subplots(nrows=2, figsize=(20, 12))
  ...
  # Save the figure
  plt.savefig(f"{file_name}_interval_{interval_number}_mouthdata.png", bbox_inches='tight')
  plt.clf()